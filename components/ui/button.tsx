  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-sm",
  {
    variants: {
      variant: {
        ...
        coolbalu: "bg-coolbalu-orange text-white hover:bg-coolbalu-orange-hover hover:shadow-md active:scale-[0.98] font-semibold",
        coolbalu_outline: "border-2 border-coolbalu-orange text-coolbalu-orange bg-transparent hover:bg-coolbalu-orange hover:text-white font-semibold",
      },
      size: {
